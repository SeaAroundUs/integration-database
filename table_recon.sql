...
CREATE TABLE recon.raw_catch (
    ...
    original_country_fishing_id integer,
    eez character varying(200) NOT NULL,
    eez_id integer NOT NULL DEFAULT 0, --0 is associated to High Seas
    eez_sub_area character varying(200),
    ...
    reporting_status character varying(200) NOT NULL,
    ...
    amount double precision NOT NULL,
    adjustment_factor numeric(20,12),
    gear_type character varying(200) NOT NULL,
    gear_type_id integer NOT NULL DEFAULT 0,
    input_type character varying(200) NOT NULL,
    input_type_id integer NOT NULL DEFAULT 0,
