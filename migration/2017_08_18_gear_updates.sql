ALTER TABLE recon.raw_catch ALTER COLUMN gear_type SET NOT NULL;
ALTER TABLE recon.raw_catch ALTER COLUMN gear_type_id SET NOT NULL;
ALTER TABLE recon.raw_catch ALTER COLUMN gear_type_id SET DEFAULT 0;

ALTER TABLE recon.raw_catch ADD COLUMN gear_notes text;
